        ...
        <h3><?=$this->title?></h3> 
             ...
             <?php $form = ActiveForm::begin([
                ...
                <div class="row">
                    ...
                    echo $form->field($model, 'carrera_id',['options'=>['class'=>'input-field col m12']])->dropDownList($datos, ['prompt'=>'Seleccione Carrera'])->label(false); 
                ...
                <div class="row">
                    ...
                    echo $form->field($model, 'tipo',['options'=>['class'=>'input-field col m12']])->dropDownList($datos, ['prompt'=>'Seleccione Tipo de Constancia'])->label(false); 
                
                ?>    
                </div>
                <div class="row">
                    <?= $form->field($model, 'cantidad',['options'=>['class'=>'input-field col m12']])->begin() ?>                        
                ...
                <div class="row">
                    <?= $form->field($model, 'interesado',['options'=>['class'=>'input-field col m12']])->begin() ?>                        
