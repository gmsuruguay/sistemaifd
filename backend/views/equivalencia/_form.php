...
<div class="acta-form">
        ...
        <?= $form->field($model, 'fecha_examen')->label(false)->textnput() ?>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <?= $form->field($model, 'fecha_examen')->label(false)->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($model, 'resolucion')->label(false)->textInput(['placeholder'=>'Resolución', 'required'=> 'required']) ?>
            </div>
            <div class="col-md-3">
